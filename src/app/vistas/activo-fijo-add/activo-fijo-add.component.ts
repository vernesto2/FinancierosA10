...
import { DepartamentoModel } from 'app/models/departamento.model';
import { AquisicionActivoModel } from 'app/models/adquisicionActivo.model';
...
export class ActivoFijoAddComponent implements OnInit {
  ...
  adquisicionActivo= new AquisicionActivoModel();
  nombreactivo:string;
  //combox
